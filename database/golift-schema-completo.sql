-- ============================================================
-- GoLift — Schema Completo (Idempotente)
-- Combina supabase-schema.sql + migration-002-feedback-readiness.sql
...
CREATE TABLE IF NOT EXISTS public.admin_workouts (
  id BIGSERIAL PRIMARY KEY,
  nome TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.admin_workout_exercises (
  id BIGSERIAL PRIMARY KEY,
...
-- ========================
-- RLS POLICIES (DROP + CREATE para idempotência)
-- ========================
...
-- Workout Feedback (migration-002)
...
-- Calculate readiness score (1-10) from metrics
